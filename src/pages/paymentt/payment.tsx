    ...
    return (
        <><><NavBar /><main>
                <div className="min-w-screen min-h-screen bg-gray-50 py-5">
                    <div className="px-5">
                        <div className="mb-2">
                            <Link to={'#'} className="focus:outline-none hover:underline text-gray-500 text-sm"><i className="mdi mdi-arrow-left text-gray-400"></i>Back</Link>
                        </div>
                        <div className="mb-2">
                            <h1 className="text-3xl md:text-5xl font-bold text-gray-600">CHECK OUT.</h1>
                        </div>
                        <div className="mb-5 text-gray-400">
                            <Link to={'#'} className="focus:outline-none hover:underline text-gray-500">Cart</Link> / <span className="text-gray-600">Checkout</span>
                        </div>
                    </div>
