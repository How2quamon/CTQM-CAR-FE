        ...
        <React.Fragment>
            ...
            <div className="flex flex-col gap-6">
                ...
                <div className="flex items-end">
                    <Filter setFilter={setFilter} filter={filter} loading={false} />
                </div>
            </div>
                    ...
                    listCars.map((car, index) => (
                        <Card key={index} loading={loading}>
                            ...
                            <div className="flex flex-col gap-3">
                                ...
                                <Link to={'/product-details/{car.id}'}><Button className='w-full'>Details</Button></Link>
                            </div>
                        </Card>
                    ))
                ) : (
                    <p className='text-[15px] font-semibold mt-2'>No cars available</p>
                )}
            </section>
            <Footer />
        </React.Fragment>
