    ...
    export default function Register() {
        ...
        interface DataNodeType {
            ...
            const [formData, setFormData] = useState<VMLogin>({
                Email: '',
                Password: '',
                KeepLogedIn: false,
                NewEmail: '',
            ...
            const onFinish = () => {
                // Có thể bạn muốn thực hiện một số logic khác sau khi nhấn nút "Đăng ký"
                // Nếu không, bạn có thể bỏ trống phần này.
            };
                    ...
                    <div className='flex justify-center bg-slate-200'>
                        <div className='w-2/5 bg-slate-900 text-white flex justify-center rounded-l-lg py-36 px-12 flex-col'>
                            <div className='w-[100px]'>
                                <img src={logo} className='mt-[-270px]' />
                            </div>
                            <div className='mt-[-60px]'>
                                ...
                                <Link to={'/login'}>
                                    <div className='flex justify-center'>
                                        <Button className='border-2 border-white rounded-full px-10 py-2 flex items-center font-semibold hover:bg-white hover:text-slate-900 text-white' htmlType='submit'>
                                            Register
                                        </Button>
                                    </div>
                                </Link>
                        ...
                        <div id='form' className='bg-slate-50 p-6 rounded-r-lg shodow-md shadow-slate-300 w-[580px]'>
                            ...
                            >
                                ...
                                <Form.Item
                                    ...
                                    rules={[{ required: true, message: 'Please enter your first and last name!', whitespace: true }]}
                                >
                                    <Input />
                                </Form.Item>
                                <Form.Item
                                ...
                                <Form.Item
                                    ...
                                    rules={[
                                        {
                                            validator: (_, value) => (value ? Promise.resolve() : Promise.reject(new Error('Bạn phải đồng ý với điều khoản!'))),
                                        },
                                    ]}
                                >
                                    <div className='flex justify-start'>
                                        <Checkbox>
                                            I already read <a href=''>rules</a>
                                        </Checkbox>
                                    </div>
                                </Form.Item>
