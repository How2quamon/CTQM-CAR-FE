                ...
                <div className="bg-white rounded-2xl shadow-2xl flex w-2/3 max-w-4xl">
                    <div className="w-3/5 p-[50px]">
                        ...
                        <div className='flex flex-col items-center justify-center '>
                            ...
                            >
                                ...
                                <Form.Item className='w-[260px] mb-2'                                
                                    name="password"
                                ...
                                <Form.Item>
                                    ...
                                    <Button className='border-2 border-slate-900  text-black-500 !rounded-full h-10 !px-10 !py-2 font-semibold 
                    ...
                    <div className="w-2/5 bg-slate-900 text-white rounded-tr-2xl round-br-2xl py-36 px-12 flex flex-col justify-start">
                        <Link to={''}>
                            ...
                            <p className='my-5'>Fill up your information and start shopping which us.</p>
                            <Link to={'/register'}>
                                <div className="flex justify-center">
                                    <Button className='border-2 border-white rounded-full h-10 px-10 py-2 flex items-center font-semibold hover:bg-white
